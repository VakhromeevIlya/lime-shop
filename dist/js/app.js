(() => {
  ...
  const H = {
      attachEvents: function () {
        ...
        (e.onTouchStart = A.bind(e)),
          ...
          (e.onClick = G.bind(e)),
          n.touch && !N && (t.addEventListener("touchstart", V), (N = !0)),
          j(e, "on");
      },
    ...
    t({
      ...
      s("click", (t, s) => {
        const { $nextEl: i, $prevEl: r } = e.navigation,
          a = s.target;
        if (e.params.navigation.hideOnClick && !h(a).is(r) && !h(a).is(i)) {
          if (
            e.pagination &&
            e.params.pagination &&
    ...
    Z(),
      document.querySelector(".sale__slider") &&
        new J(".sale__slider", {
          ...
          loop: !0,
          navigation: {
            nextEl: ".sale__arrows .arrows__right",
            prevEl: ".sale__arrows .arrows__left",
          },
          breakpoints: {
      ...
      document.querySelector(".review__slider") &&
        new J(".review__slider", {
          ...
          spaceBetween: 15,
          navigation: {
            nextEl: ".review__arrows .arrows__right",
            prevEl: ".review__arrows .arrows__left",
          },
          breakpoints: {
  ...
  document.addEventListener("click", function (e) {
    let t = e.target,
      s = t.parentElement,
      i = document.querySelectorAll(".menu__item._ok");
    t.classList.contains("_icon-arrow-down") && s.classList.toggle("_ok");
    i.length > 1 && te(i, "_ok");
    !t.closest(".menu__item") && i.length > 0 && te(i, "_ok");
    t.classList.contains("_icon-search")
      ? document
          .querySelector(".header__form")
          .classList.toggle("_search-active")
      : !t.closest(".header__form") &&
